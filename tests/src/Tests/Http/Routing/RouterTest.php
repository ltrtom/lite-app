...
namespace LiteApplication\Tests\Http\Routing;


use LiteApplication\Http\Routing\RouteException;
...
class RouterTest extends \PHPUnit_Framework_TestCase{
    ...
    /**
     * @expectedException LiteApplication\Http\Routing\RouteException
     */
